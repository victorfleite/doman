...
$this->title = Yii::t('translation', 'Licenca');
...
<div class="licenca-index">
    ...
    <p>
        <?= Html::a(Yii::t('translation', 'Create Licenca'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
<?php 
    $gridColumn = [
        ...
        [
                ...
                'value' => function($model){
                    return $model->educador->id;
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\doman\models\Educador::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Educador', 'id' => 'grid--educador_id']
            ],
        'data_inicio',
        'data_fim',
        'data_criacao',
